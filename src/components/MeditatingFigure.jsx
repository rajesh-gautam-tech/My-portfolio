...
export default function MeditatingFigure() {
  ...
  // Only force-kill animation/transform WHILE actively dragging.
  // Once dragging stops, CSS takes back over so hover-dance keeps working
  // no matter where the doll currently is on screen.
  const style = pos
    ? {
        left: `${pos.left}px`,
        top: `${pos.top}px`,
        ...
        ...(dragging ? { transform: "none", animation: "none" } : {}),
      }
    : { cursor: "grab" };

  const cls = [pos ? "dragged" : "", dragging ? "is-dragging" : ""]
    .filter(Boolean)
    .join(" ");
  ...
  return (
    ...
    >
      ...
      <ellipse className="cheek" cx="31" cy="22" rx="2" ry="2.5" fill="#c96040" opacity=".5" />
      <ellipse className="cheek" cx="41" cy="22" rx="2" ry="2.5" fill="#c96040" opacity=".5" />
      ...
      <path className="arm-left" d="M20,40 Q10,48 11,58 Q15,62 20,58 Q22,52 22,44" fill="#e07855" />
      <path className="arm-right" d="M52,40 Q62,48 61,58 Q57,62 52,58 Q50,52 50,44" fill="#e07855" />
